  ...
  return (
    <div className="case-details-tab">
        ...
        <div className="case-hero-overlay">
          <div className="case-hero-content">
            ...
            <div className="case-hero-badges">
              <span className="badge">{t('pages.gameRoom.caseDetails.minXp')} {gameCase.min_player_XP}</span>
              <span className="badge reward">{t('pages.gameRoom.caseDetails.reward')} {gameCase.XP_on_solve} {t('pages.gameRoom.caseDetails.xp')}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="case-full-story">
        <h2 className="section-title">{t('pages.gameRoom.caseDetails.officialBriefing')}</h2>
      ...
      {accumulatedVictims.length > 0 && (
        <div className="case-victims-section" style={{ marginTop: '3rem', borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '3rem' }}>
          <h2 className="section-title" style={{ borderColor: 'var(--accent-crimson)', color: 'var(--accent-crimson)' }}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                    ...
                    <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.75rem', color: 'var(--accent-crimson)', marginBottom: '0.5rem' }}>
                      {t('pages.gameRoom.caseDetails.vic')}{victim.id.toString().padStart(4, '0')}
                    </span>
                    {victim.background && (
                      <p style={{
