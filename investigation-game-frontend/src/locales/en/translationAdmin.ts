export const translations = {
  adminDashboard: {
    ...
    charactersTab: "👤 Roster / Characters",
  ...
  forms: {
    ...
    evidenceForm: {
      ...
      digitalOption: "Digital Forensics",
      ballisticsOption: "Ballistics Analysis",
      customOption: "Custom Artifact",
      evidenceTitleLabel: "Evidence Title",
      evidenceDescLabel: "Short Description (Hover text / Caption)",
      strategyLabel: "Viewer Presentation",
      strategyHint: "How this file is presented to players.",
      strategyOptions: {
        paper: "Printed Document",
        terminal: "Terminal Screen",
        media: "Media File",
        artifact: "Sandboxed Artifact"
      },
      paperFinishLabel: "Paper Stock",
      paperFinishOptions: {
        blank: "Blank Sheet",
        manila: "Manila Envelope"
      },
      pagedBuilderLabel: "Document Pages",
      artifactBuilderLabel: "Artifact Source",
      artifactHtmlLabel: "Artifact HTML",
      artifactHtmlHint: "Rendered inside a sandboxed frame. Scripts run, but the frame cannot reach the game's session.",
      artifactCssLabel: "Artifact CSS",
      artifactCssHint: "Applied inside the sandboxed frame only.",
    ...
    characterForm: {
      ...
      missingContextTitle: "[ MISSING CONTEXT: NO CASE SELECTED ]",
      missingContextDesc: "Please select a Target Case from the Global Directory to manage Characters.",
      initialCharacterLabel: "Initial Discovery",
      initialCharacterDesc: "Unlocked on the board immediately when the case starts.",
      guiltyVerdictLabel: "Guilty Target",
      guiltyVerdictDesc: "This individual is an actual perpetrator required to solve the case.",
      nameLabel: "Full Name / Alias",
      backgroundLabel: "Background Intel",
      defaultStatusLabel: "Initial Status",
      chargeLabel: "Criminal Charge",
      imageHint: "Optimal: 1:1 (Square) ratio. Face centered. Min 400x400px. WEBP or JPG. Max 4MB.",
      storeLocallyLabel: "Store Locally on Server",
      processingData: "Processing Data...",
      commitCharacter: "Commit Character",
      updateCharacter: "Update Record",
      manageTitle: "Manage Roster",
      emptyMessage: "No characters found for this case.",
    ...
    choiceEditorCard: {
      ...
      unlockCharactersLabel: "Unlock Characters",
      markDeceasedLabel: "Report as Deceased",
